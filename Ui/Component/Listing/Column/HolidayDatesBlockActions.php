...
namespace SelectCo\HolidayDates\Ui\Component\Listing\Column;
 ...
 */
class HolidayDatesBlockActions extends Column
{
    /**
     * Entity name.
     */
    private const ENTITY_NAME = 'HolidayDates';

    /**
     * Url paths.
     */
    private const EDIT_URL_PATH = 'holiday_dates/holidaydates/edit';
    private const DELETE_URL_PATH = 'holiday_dates/holidaydates/delete';
    ...
    public function prepareDataSource(array $dataSource): array
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item[HolidayDatesInterface::HOLIDAY_DATES_ID])) {
                    $entityName = static::ENTITY_NAME;
                    $urlData = [HolidayDatesInterface::HOLIDAY_DATES_ID => $item[HolidayDatesInterface::HOLIDAY_DATES_ID]];
